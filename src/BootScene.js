class BootScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('cat_idle', 'assets/cat-idle.png?v=304');
        this.load.image('cat_run', 'assets/cat-run.png?v=304');
        this.load.image('cat_sleep', 'assets/cat-sleep.png?v=304');
