class BootScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('cat_idle', 'assets/cat-idle.png?v=302');
        this.load.image('cat_run', 'assets/cat-run.png?v=302');
        this.load.image('cat_sleep', 'assets/cat-sleep.png?v=302');
        this.load.image('cat_adventure_idle', 'assets/cat-adventure-idle.png?v=302');
