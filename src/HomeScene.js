class HomeScene extends Phaser.Scene {
    ...
    create() {
        ...
        room.setDepth(-10);
        room.fillStyle(0xf5e2d6, 1);
        room.fillRect(0, 0, W, H * 0.54);
        room.fillStyle(0xecddd2, 1);
        room.fillRect(0, H * 0.54, W, H * 0.46);
        room.fillStyle(0xd8cab8, 1);
